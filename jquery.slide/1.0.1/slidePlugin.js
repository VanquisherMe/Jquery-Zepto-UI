...
;(function (factory) {
    ...
    var Bnr = function(element , options){
    ...
    Bnr.prototype.sliderNavFnc=function(){
    ...
    Bnr.prototype.sliderBtnFnc=function(){
        var $this=this, $elem = this.element,_op=this.option;
    ...
    //loop 循环
    Bnr.prototype.loopFnc=function(){
        var $this=this, $elem = this.element,_op=this.option;
    ...
    //获得当前 索引
    Bnr.prototype.stateIndex=function(bol){
        var _op=this.option,
            len= this.len,
            staI=_op.stateInit;
    ...
    //同步 view
    Bnr.prototype.viewSync=function(){
        var $this=this, $elem = this.element,_op=this.option;
    ...
    Bnr.prototype.sliderNavHTML= function(len){
        var strHTML='';
        for(var i=0; i<len; i++){
            strHTML+='<li></li>'
        }
    ...
    Bnr.prototype.sliderBtnHTML= function(){

        return $('<a class="sliderBtns sliderBtn-Prev "> < </a><a class="sliderBtns sliderBtn-Next "> > </a> ')
    };
    // BNR PLUGIN DEFINITION
    // =====================

    function Plugin(option) {
        return this.each(function () {
            var $this = $(this);
            var data  = $this.data('rn.bnr');

            if (!data) $this.data('rn.bnr', ( data = new Bnr(this , option) ))
